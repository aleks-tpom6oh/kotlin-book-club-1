...
data class Forecast(val dt: Long, val main: MainForecast,
                    val weather: List<Weather>, val clouds: Clouds, val wind: Wind, val rain: Map<String, Double>, val dt_txt: String)
data class Weather(val id: Long, val main: String, val description: String, val icon: String)
data class MainForecast(val temp: Double, val temp_min: Double, val temp_max: Double, val pressure: Double, val humidity: Int)
